...
class TestPyprojectToml(unittest.TestCase):
    ...
    def test_has_manifest_should_check_the_manifest_exists_for_tool(self):
        # Arrange
        with fixtup.up('manifests_tool_version'):
            cwd = os.getcwd()
    ...
    def test_contains_settings_should_check_if_fixtup_section_is_present_in_manifest_for_tool(self):
        # Arrange
        with fixtup.up('manifests_tool_version'):
            cwd = os.getcwd()
    ...
    def test_read_settings_should_load_manifest_information_for_tool(self):
        # Arrange
        with fixtup.up('manifests_tool_version') as wd:
            cwd = os.getcwd()
